...
>
> If you were writing a script that needed a user to load a certain package,
> it is better to check if they've installed it, then load or install+load as 
...
Okay, so we've loaded the package. Let's used `?` to look at the help file.
