 ...
 * Because the data are not actually *live* cell counts, but instead are just
    ...
    an increasing of dead cells floating around that are also being counted,
 * These microbes often have high DNA mutation rates, and some individuals might
...
the "Bacterial growth" page on Wikipedia explains how many people think of 
