...
parameters, I'm going to define a new function `log_growth`, that takes
...
> Take some time now to play around with those parameters. Can you come
> up with a better fit? It seems clear that we can't quite get this
> perfect either. Why not? Can you come up with any biological reasons
> why our logistic model isn't perfect?

<p style="text-align: right; font-size: small;">
Page built on: 2018-09-12 at 11:34:27
</p>
