...
is more complicated. One way to represent this solution is as
\begin{equation}
  N(t) = \frac{KN(0)}{N(0)+(K-N(0))e^{-rt}}
\end{equation}


I'll get you started, but you'll need to fiddle around to find the best choices of parameters.
