...
As good organizational practice, make sure you save it to your `scripts/` folder 
in your project directory for these lessons.
...
to select the whole line), then press the same key combination: <kbd>Ctrl</kbd> + <kbd>Shift</kbd> + <kbd>C</kbd>.
