...
For these lessons, we will need a `data/` folder to store our raw data, and we
...
* Under the `Files` tab on the right of the screen, click on `New Folder` and
  ...
  (e.g., `~/R-QBio/data`). (Alternatively, type `dir.create("data")` at
  your R console.) Repeat these operations to create a `data_output/`, a
  `fig_output/`, and a `scripts/` folder.
