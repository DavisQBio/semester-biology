...
>     mix these types in a single vector? <details>
>     <summary>Answer</summary> *R implicitly converts them to all be
>     the same type.* </details>
>
...
> type. R tries to convert (coerce) the content of this vector to find a
> "common denominator" that doesn't lose any information. </details>
>
...
> ### Challenge (optional) {#challenge-optional .challenge}
>
